...
OpenGUI.Text = "X"
OpenGUI.TextColor3 = Color3.new(1, 0, 0)
OpenGUI.TextSize = 38
...
SideFrameTitle.Text = "[Gui By Kallixern]"
SideFrameTitle.TextSize = 21
SideFrameTitle.TextStrokeColor3 = Color3.new(5, 5, 5)
SideFrameTitle.TextStrokeTransparency = 1
...
GuiBottomFrame.BackgroundColor3 = Color3.new(0, 0, 0)
...
Credits.Text = "Original By illremember"
Credits.TextColor3 = Color3.new(10, 10, 10)
Credits.TextSize = 14
Credits.TextStrokeColor3 = Color3.new(0, 0.870588, 0.713726)
...
DinoWalk.BorderColor3 = Color3.new(1, 0.313726, 0.313726)
...
DinoWalk.Text = "WIP Arm Brush"
DinoWalk.TextSize = 20
DinoWalk.TextWrapped = true

FloorCrawl.Name = "SwordSliceDown"
...
FloorCrawl.Text = "SwordSliceDown"
...
FloatingHead.BorderColor3 = Color3.new(1, 0.313726, 0.313726)
...
FloatingHead.Text = "WIP Leg Move"
...
GuiTopFrame.BackgroundColor3 = Color3.new(0, 0, 0)
GuiTopFrame.BorderColor3 = Color3.new(0, 0, 0)
...
Title.TextColor3 = Color3.new(0, 2, 3)
Title.TextSize = 20
Title.TextStrokeColor3 = Color3.new(0, 2, 3)
Title.TextStrokeTransparency = 1
Title.TextWrapped = true
--showing r6
CheckR.Name = "CheckR"
CheckR.Parent = GuiTopFrame
CheckR.BackgroundColor3 = Color3.new(0, 0, 0)
...
-- Buttons
col = Color3.new(2, 2, 0)
loc = Color3.new(0, 1, 0)
rcol = Color3.new(0, 0, 1)
rloc = Color3.new(0, 1, 2)
...
local Anim = Instance.new("Animation")
Anim.AnimationId = "rbxassetid://31665427"
local track = game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(Anim)
...
CloneIllusion.MouseButton1Click:connect(function()
	...
	if CloneIllusionACTIVE then
		track:Play(.0.00011, 9e9999, 9e9999)
...
BarrelRoll.MouseButton1Click:connect(function()
	...
	if BarrelRollACTIVE then
		...
		while wait() do
		 if track.IsPlaying == false then
			if BarrelRollACTIVE then
				track:Play(.0.0001, 9e9999, 9e9999)
			end
		 end
		end
	else
